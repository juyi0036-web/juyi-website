          ...
          <div className="hidden md:flex flex-col items-end space-y-1">
            <div className="flex items-center">
              <a 
                ...
                className="bg-choco text-cream border-2 border-choco px-3 py-1.5 rounded-full text-sm font-bold hover:bg-cream hover:text-choco transition flex items-center no-underline shadow-sm"
              >
            ...
            <form onSubmit={onSearchSubmit} className="w-full flex justify-end items-center space-x-2">
              <input
                type="search"
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                placeholder={searchPlaceholder}
                className="w-40 sm:w-44 md:w-48 px-3 py-2 bg-white border border-gray-300 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-choco focus:border-choco transition"
              />
