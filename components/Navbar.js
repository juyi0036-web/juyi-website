          ...
          <div className="hidden md:flex flex-col items-end space-y-2">
            ...
            <form onSubmit={onSearchSubmit} className="w-full flex justify-end">
              <input
                ...
                className="w-64 px-4 py-2 bg-white border border-gray-300 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-choco focus:border-choco transition"
              />
            </form>
          </div>
        </div>
