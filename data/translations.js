export const translations = {
  ...
  fr: {
    ...
    about_tagline: "Basée à Shanghai, Juyi CHR est bien plus qu'une société de négoce. Nous sommes votre pont vers l'industrie chinoise.",
    about_story_title: "Notre Histoire",
    about_story_p1: "Notre stratégie est pilotée par une expertise française de plus de 40 ans dans les arts de la table et l'équipement hôtelier. Cette double culture nous permet de comprendre vos exigences de qualité (Design, Normes, Finitions) et de les traduire techniquement auprès de nos usines partenaires.",
