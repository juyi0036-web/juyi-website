export const translations = {
  ...
  fr: {
    ...
    trend_label_3: "Conformité Future",
    trend_takeaway_title: "Insight Stratégique",
    trend_1_takeaway: "Les grandes chaînes européennes triplent leur capacité avec ces lignes, sans personnel supplémentaire.",
    trend_2_takeaway: "Le sourcing direct libère du budget pour des spécifications de meilleure qualité.",
    trend_3_takeaway: "Les équipements non conformes risquent l'interdiction d'importation d'ici 2026.",
  ...
  en: {
    ...
    trend_label_3: "Future Proofing",
    trend_takeaway_title: "Strategic Insight",
    trend_1_takeaway: "Top European chains use these exact lines to triple capacity without hiring more staff.",
    trend_2_takeaway: "Direct sourcing unlocks the budget for higher quality specs.",
    trend_3_takeaway: "Non-compliant equipment may face import bans by 2026—buy safe now.",
  ...
  es: {
    ...
    trend_label_3: "Garantía de Futuro",
    trend_takeaway_title: "Insight Estratégico",
    trend_1_takeaway: "Las principales cadenas europeas usan estas líneas para triplicar capacidad sin contratar más personal.",
    trend_2_takeaway: "El sourcing directo libera presupuesto para especificaciones de mayor calidad.",
    trend_3_takeaway: "Los equipos no conformes enfrentarán prohibiciones de importación para 2026.",
