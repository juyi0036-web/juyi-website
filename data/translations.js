export const translations = {
  ...
  fr: {
    ...
    // Smart Assistant
    assistant_badge: "ASSISTANT IA",
    assistant_section_title: "Votre Expert CHR Personnel",
    assistant_section_desc: "Posez vos questions, obtenez un devis, ou contactez notre équipe. Notre assistant IA vous répond instantanément.",
    assistant_title: "Assistant JUYI CHR",
    assistant_status: "En ligne • Répond instantanément",
    assistant_placeholder: "Tapez votre message...",
    assistant_powered: "Propulsé par l'IA • Réponse en quelques secondes",
    assistant_welcome: "Bonjour ! Je suis l'assistant JUYI CHR. Comment puis-je vous aider aujourd'hui ?\n\nJe peux vous renseigner sur :\n- Nos équipements CHR & Boulangerie\n- Les réglementations UE 2026\n- Obtenir un devis gratuit\n- Notre processus de sourcing",
    quick_products: "📦 Nos Produits",
    quick_products_msg: "Quels équipements proposez-vous ?",
    quick_eu2026: "🇪🇺 Normes UE 2026",
    quick_eu2026_msg: "Quelles sont les nouvelles normes UE 2026 ?",
    quick_quote: "💰 Demander un Devis",
    quick_quote_msg: "Je souhaite obtenir un devis",
    quick_contact: "📞 Nous Contacter",
    quick_contact_msg: "Comment vous contacter ?",
    ask_company: "Quel est le nom de votre entreprise ?",
    ask_name: "Quel est votre nom ?",
    ask_email: "Quel est votre email ?",
    ask_phone: "Quel est votre numéro de téléphone (optionnel) ? Tapez 'skip' pour passer.",
    ask_category: "Quelle catégorie d'équipement vous intéresse ?\n1. Boulangerie & Pâtisserie\n2. Fours & Ligne Chaude\n3. Espace & Hygiène (Inox)\n4. Froid & Glace\n5. Autre",
    ask_requirements: "Décrivez vos besoins spécifiques (quantités, spécifications, budget) :",
    inquiry_thanks: "Merci ! Votre demande a été envoyée. Notre équipe vous contactera dans les 24 heures.",
    inquiry_success_title: "Demande Envoyée !",
    inquiry_success_desc: "Notre équipe vous contactera dans les 24 heures.",
    inquiry_again: "Envoyer une autre demande",
  ...
  en: {
    ...
    assistant_section_title: "Your Personal CHR Expert",
    assistant_section_desc: "Ask questions, get a quote, or contact our team. Our AI assistant responds instantly.",
    assistant_title: "JUYI CHR Assistant",
    assistant_status: "Online • Responds instantly",
    assistant_placeholder: "Type your message...",
    assistant_powered: "Powered by AI • Response in seconds",
    assistant_welcome: "Hello! I'm the JUYI CHR assistant. How can I help you today?\n\nI can help with:\n- CHR & Bakery equipment\n- EU 2026 regulations\n- Get a free quote\n- Our sourcing process",
    quick_products: "📦 Our Products",
    quick_products_msg: "What equipment do you offer?",
    quick_eu2026: "🇪🇺 EU 2026 Standards",
    quick_eu2026_msg: "What are the new EU 2026 standards?",
    quick_quote: "💰 Request a Quote",
    quick_quote_msg: "I'd like to get a quote",
    quick_contact: "📞 Contact Us",
    quick_contact_msg: "How to contact you?",
    ask_company: "What is your company name?",
    ask_name: "What is your name?",
    ask_email: "What is your email?",
    ask_phone: "What is your phone number (optional)? Type 'skip' to skip.",
    ask_category: "Which equipment category interests you?\n1. Bakery & Pastry\n2. Ovens & Hot Line\n3. Space & Hygiene (Stainless)\n4. Refrigeration & Ice\n5. Other",
    ask_requirements: "Describe your specific needs (quantities, specifications, budget):",
    inquiry_thanks: "Thank you! Your request has been sent. Our team will contact you within 24 hours.",
    inquiry_success_title: "Request Sent!",
    inquiry_success_desc: "Our team will contact you within 24 hours.",
    inquiry_again: "Submit another request",
  ...
  es: {
    ...
    assistant_section_title: "Su Experto CHR Personal",
    assistant_section_desc: "Haga preguntas, obtenga un presupuesto o contacte a nuestro equipo. Nuestro asistente IA responde al instante.",
    assistant_title: "Asistente JUYI CHR",
    assistant_status: "En línea • Responde al instante",
    assistant_placeholder: "Escriba su mensaje...",
    assistant_powered: "Potenciado por IA • Respuesta en segundos",
    assistant_welcome: "¡Hola! Soy el asistente JUYI CHR. ¿Cómo puedo ayudarle hoy?\n\nPuedo ayudarle con:\n- Equipos CHR y Panadería\n- Regulaciones UE 2026\n- Obtener un presupuesto gratis\n- Nuestro proceso de sourcing",
    quick_products: "📦 Nuestros Productos",
    quick_products_msg: "¿Qué equipos ofrecen?",
    quick_eu2026: "🇪🇺 Normas UE 2026",
    quick_eu2026_msg: "¿Cuáles son las nuevas normas UE 2026?",
    quick_quote: "💰 Solicitar Presupuesto",
    quick_quote_msg: "Me gustaría obtener un presupuesto",
    quick_contact: "📞 Contactar",
    quick_contact_msg: "¿Cómo contactarlos?",
    ask_company: "¿Cuál es el nombre de su empresa?",
    ask_name: "¿Cuál es su nombre?",
    ask_email: "¿Cuál es su email?",
    ask_phone: "¿Cuál es su número de teléfono (opcional)? Escriba 'skip' para omitir.",
    ask_category: "¿Qué categoría de equipo le interesa?\n1. Panadería y Pastelería\n2. Hornos y Línea Caliente\n3. Espacio e Higiene (Inoxidable)\n4. Refrigeración y Hielo\n5. Otro",
    ask_requirements: "Describa sus necesidades específicas (cantidades, especificaciones, presupuesto):",
    inquiry_thanks: "¡Gracias! Su solicitud ha sido enviada. Nuestro equipo lo contactará dentro de 24 horas.",
    inquiry_success_title: "¡Solicitud Enviada!",
    inquiry_success_desc: "Nuestro equipo lo contactará dentro de 24 horas.",
    inquiry_again: "Enviar otra solicitud",
    ...
    description_short: "Gratuit, en 3 questions. Calcule tes économies d'énergie avec Asseng.",
    whatsapp_hero_title: "Devis Énergie Gratuit en 3 Questions",
    whatsapp_hero_desc: "Réponds à ces questions simples et découvres combien tu peux économiser avec une pompe à chaleur.",
    rgpd_notice: "Tes données sont protégées. Nous ne les revendons pas. Tu peux demander leur suppression à tout moment.",
    q1_label: "Quel type d'établissement as-tu ?",
    est_restaurant: "Restaurant",
    est_hotel: "Hôtel",
    est_cafe: "Café / Bar",
    est_boulangerie: "Boulangerie / Pâtisserie",
    est_brasserie: "Brasserie",
    est_collectivite: "Collectivité / Établissement public",
    q2_label: "Quelle est ta source d'énergie actuelle pour le chauffage ?",
    energy_gaz: "Gaz Naturel",
    energy_fuel: "Fuel / Gazoil",
    energy_electrique: "Électricité (radiateurs)",
    energy_chaudiere: "Chaudière (gaz/fuel)",
    energy_autre: "Autre",
    q3_label: "Quel est l'âge du bâtiment ?",
    age_05: "Moins de 5 ans",
    age_510: "5 à 10 ans",
    age_1015: "10 à 15 ans",
    age_15plus: "Plus de 15 ans",
    q4_label: "Quelle est la surface chauffée (m²) ?",
    surface_placeholder: "Ex : 250",
    phone_label: "Téléphone (pour te contacter)",
    email_label: "Email (optionnel, pour recevoir le PDF)",
    error_network: "Erreur réseau, vérifie ta connexion",
    btn_calculating: "Calcul en cours…",
    btn_calculate: "Calculer mes économies",
    result_title: "Bravo ! Voici ton estimation",
    annual_savings: "Économies annuelles",
    subsidies_total: "Subventions totales",
    roi: "Retour sur investissement",
    why_this_price: "Pourquoi ce prix ?",
    why_desc: "Notre estimation inclut :",
    next_step_1: "Un conseiller Asseng t'appellera sous 24h pour confirmer les détails.",
    next_step_2: "Tu recevras une étude technique gratuite avec le devis détaillé.",
    next_step_3: "Nous t'aidons aussi à monter ton dossier CEE / MaPrimeRénov'.",
    cta_contact: "Parler à un expert",
    delete_data: "Supprimer mes données",
    footer_rgpd: "Protection des données RGPD. Tes informations ne sont pas revendues.",
    privacy_policy: "Politique de confidentialité",

    // Technician Portal
    technician_title: "Portail Technicien Asseng",
    technician_desc: "Formulaire de collecte pour installateurs RGE",
    technician_success_title: "Devis généré",
    technician_success: "Devis généré avec succès",
    technician_success_desc: "Le devis a été généré et téléchargé. Un email a été envoyé au client.",
    back_to_home: "Retour à l'accueil",
    new_submission: "Nouvelle soumission",
    rgpd_notice_tech: "Les données sont stockées de manière sécurisée. Tu peux demander leur suppression à tout moment.",
    sec_lead: "Client prospect",
    lead_phone: "Téléphone du client (WhatsApp)",
    lead_found: "Client trouvé",
    sec_identity: "Identité technicien",
    tech_name: "Nom",
    tech_rge: "Numéro RGE",
    tech_company: "Entreprise",
    sec_measurements: "Mesures du site",
    surface_utile: "Surface utile (m²)",
    hauteur: "Hauteur sous plafond (m)",
    couverts: "Nombre de couverts",
    chambres: "Nombre de chambres",
    type_local: "Type de local surveillé",
    orientation_facade: "Orientation façade",
    orientation_toiture: "Orientation toiture",
    sec_equipment: "Équipement proposé",
    pac_power: "Puissance PAC (kW)",
    refrigerant: "Fluide frigorigène",
    indoor_units: "Nb d'unités intérieures",
    sound_level: "Niveau sonore (dB)",
    model_name: "Modèle (Référence fabricant)",
    backup_heater: "Appoint chauffage",
    sec_photos: "Photos du site",
    photos_outdoor: "Unité extérieure",
    photos_indoor: "Unités intérieures",
    photos_install: "Installation globale",
    sec_notes: "Notes techniques",
    notes_placeholder: "Contraintes, observations, spécifications client...",
    btn_submitting: "Soumission en cours…",
    btn_submit: "Soumettre & Générer le devis PDF"
