export const translations = {
  ...
  fr: {
    ...
    about_h1: "L'Excellence du Matériel",
    about_tagline: "Le pont direct entre l'industrie de pointe et votre fournil.",
    about_story_title: "Notre Histoire",
    about_story_p1: "JUYI CHR Supply Chain Management est né d'une ambition simple : supprimer les intermédiaires inutiles entre les fabricants d'équipements de boulangerie de haute qualité et les artisans français.",
    about_story_p2: "Avec notre base opérationnelle au cœur des zones de production en Chine et notre équipe technique basée en France (disposant de plus de 40 ans d'expérience cumulée sur le marché CHR), nous garantissons non seulement le meilleur prix, mais surtout la qualité et le service de proximité.",
    about_story_p3: "Nous ne sommes pas de simples vendeurs. Nous sommes vos partenaires industriels.",
    ...
    contact_address_city: "Guangzhou, China",
